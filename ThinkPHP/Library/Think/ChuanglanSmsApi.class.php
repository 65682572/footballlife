...
class ChuanglanSmsApi
{
    ...
    const API_ACCOUNT = 'N1672883';//创蓝账号 替换成你自己的账号

    const API_PASSWORD = 'yr0FomIbC';//创蓝密码 替换成你自己的密码
     ...
     */
    static public function sendSMS($mobile, $msg, $needstatus = 1)
    {
     ...
     *
     */
    static public function execResult($result)
    {
        $result = preg_split("/[,\r\n]/", $result);
        return $result;
    }
