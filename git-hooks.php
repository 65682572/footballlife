...
$access_ip = array('115.159.117.149', '118.249.190.96');
...
//    $fs and fclose($fs);
    /* then pull master */
    $res = system("cd /home/wwwroot/www.msu7.net/ && git pull", $retval);
    fwrite($fs, '=' . $res . '=' . $retval . PHP_EOL);
    fwrite($fs, '=======================================================================' . PHP_EOL);
    $fs and fclose($fs);
...
//    $fs and fclose($fs);
//    /* pull devel branch */
//    system("cd /home/wwwroot/www.msu7.net/ && git checkout develop");
